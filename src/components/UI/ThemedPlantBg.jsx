    ...
    <div className="font-serif relative min-h-screen overflow-hidden bg-[#f3e5d8]">
      ...
      <div className="absolute inset-0 overflow-hidden">
        {[...Array(15)].map((_, i) => (
          ...
          >
            <svg className="w-10 h-10 text-[#8B4513] opacity-30" viewBox="0 0 24 24" fill="currentColor">
              <path d="M17 8C8 10 5 16 5 22M17 8C19 10 20 12 20 15M17 8C13 9 12 11 12 13M17 8C15 9 14 11 14 13" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
            </svg>
          </div>
        ))}
      </div>
    ...
    <div className="font-sans relative min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        {[...Array(20)].map((_, i) => (
          ...
          >
            <svg className="w-8 h-8 text-[#F4A460] opacity-20" viewBox="0 0 24 24" fill="currentColor">
    ...
    <div className="font-sans relative min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        {[...Array(25)].map((_, i) => (
          ...
          >
            <svg className="w-6 h-6 text-green-800 opacity-30" viewBox="0 0 24 24" fill="currentColor">
