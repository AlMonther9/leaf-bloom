  ...
  return (
    <VintagePlantBackground>
      <div className="relative overflow-x-hidden font-sans">
        {/* Hero Section */}
        <section className="flex flex-col items-center py-12 lg:flex-row md:flex-row">
          <div className="relative hidden w-full h-auto lg:h-screen md:h-screen lg:w-2/5 md:w-2/5 md:block lg:block">
          ...
          <div className="relative flex max-h-screen pt-16 lg:min-h-screen lg:items-center lg:justify-end">
            <motion.div
              className="max-w-4xl p-6 lg:pr-24"
              initial={{ opacity: 0, translateY: "100%" }}
              whileInView={{ opacity: 1, translateY: "0" }}
            >
              <motion.h1 className="mb-6 text-4xl font-bold text-green-800">
                Welcome to LEAF & BLOOM
              </motion.h1>
              <p className="mb-8 text-lg text-green-700 lg:text-xl lg:text-left">
              ...
              <motion.div
                className="space-x-4 lg:text-left"
                initial={{ opacity: 0, translateX: "100%" }}
                whileInView={{ opacity: 1, translateX: "0" }}
              >
                <motion.button
                className="flex items-center justify-center px-4 py-2 text-white transition-all duration-300 rounded-lg shadow-md lg:w-1/5 bg-quaternary hover:bg-quinary hover:shadow-lg hover:scale-105"
                onClick={() => navigate("/signup")}
                initial={{ opacity: 0, translateX: "80%" }}
                whileInView={{ opacity: 1, translateX: "0" }}
              >
                Get Started <ChevronRight className="w-6 h-6 ml-1" />
              </motion.button>
                {/* <Link
                  to="/signup"
        ...
        {/* Shop Section */}
        <section className="px-4 pb-8 mx-auto mt-12 mb-16 shadow-lg bg-gradient-to-br from-quinary to-green-100">
          <motion.div
            className="flex flex-col justify-between gap-4 md:flex-row md:px-12 lg:px-24 lg:py-16"
            {...transitionProps}
          >
            <motion.img
            ...
            />
            <motion.div
              className="flex flex-col gap-4 px-6 mx-auto my-auto md:px-0 md:w-1/2"
              {...transitionProps}
            >
              ...
              <p className="text-lg text-green-800">
                ...
                plants. Whether you're looking to add a touch of greenery to
                your office desk or create a lush oasis in your backyard, we
                have the perfect plant for you. Explore our diverse range of
                plants, each carefully selected to bring beauty, freshness, and
        ...
        {/* Community Section */}
        <section className="flex flex-col gap-4 py-8 md:py-12 lg:py-16">
          <h2 className="flex justify-center mb-12 text-xl font-bold md:text-2xl text-green-950">
            Share with community
          </h2>
          <div className="relative flex gap-4 md:gap-8 px-4 lg:px-24 bg-secondary py-20 max-h-[500px]">
            ...
            <motion.button
              ...
              className="absolute flex items-center px-8 py-2 text-white transform -translate-x-1/2 rounded-lg bg-quaternary hover:bg-emerald-800 -bottom-5 left-1/2"
              initial={{ opacity: 0, translateX: "80%" }}
              whileInView={{ opacity: 1, translateX: "0" }}
            >
        ...
        <section className="flex flex-col gap-4 px-4 py-8 md:py-12 lg:py-16 md:my-16 lg:px-24">
          ...
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            <Leaf className="relative mt-auto ml-auto rotate-180 text-tertiary w-72 h-72 md:w-96 md:h-96" />
            <motion.p
              className="relative z-10 w-11/12 p-6 text-xl text-green-800 border-2 rounded-lg shadow-md md:w-5/12 border-pinky"
              initial={{ opacity: 0, translateX: "80%" }}
              whileInView={{ opacity: 1, translateX: "0" }}
            >
              Discover a world of plants at your fingertips. Our comprehensive
              Plant Encyclopedia offers detailed information on various species,
              including care instructions, scientific names, and growing
              conditions. Use our advanced search and filter options to find the
        ...
        {/* Free Shipping Section (Visible on md and larger) */}
        <section className="flex-col items-start justify-center hidden gap-2 px-12 my-16 md:flex text-darkpink bg-shopping h-96 lg:px-24">
